...
namespace Finbourne.Scheduler.Sdk.Extensions
{
    ...
    public class ApiFactory : IApiFactory
    {
        ...
        public ApiFactory(ApiConfiguration apiConfiguration)
        {
            ...
            {
                if (string.IsNullOrWhiteSpace(apiConfiguration.SchedulerUrl))
                    throw new ArgumentNullException(
                        nameof(apiConfiguration.SchedulerUrl),
                        $"Scheduler Uri missing. Please specify either FBN_SCHEDULER_API_URL environment variable or schedulerUrl in secrets.json.");
