...
namespace Finbourne.Scheduler.Sdk.Extensions.Tests
{
    ...
    {
        private const string APP = "SCHEDULER";
        private string _secretsFile;
        private string _cachedTokenUrl;
        private string _cachedSchedulerUrl;
        ...
        public void Setup()
        {
            ...
            _cachedSchedulerUrl = Environment.GetEnvironmentVariable($"FBN_{APP}_API_URL") ??
        ...
        public void TearDown()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", _cachedSchedulerUrl);
        ...
        public void Use_Secrets_File_If_It_Exists()
        {
            PopulateDummySecretsFile(new Dictionary<string, string>
            {
                ...
                {"schedulerUrl", string.Format("<{0}Url>", "scheduler")},
            });            
        ...
        public void Use_Configuration_Section_If_Supplied()
        {
            var settings = new Dictionary<string, string>
            {
                ...
                { "api:SchedulerUrl", string.Format("<env.{0}Url>", "scheduler") },
        ...
        public void Throw_Exception_If_Configuration_Section_Incomplete()
        {
            ...
            {
                { "api:TokenUrl", "<tokenUrl>" },
                { "api:SchedulerUrl", string.Format("<{0}Url>", "scheduler") },
                { "api:ClientId", "<clientId>" },
                { "api:ClientSecret", "" },
                { "api:Username", "<username>" },
                { "api:Password", "" },
